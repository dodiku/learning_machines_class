...
jobs.add_job(True, False, 784, 200, 10, 0.05, 1, 200, 1, [20, 20, 20], 20, 0.15, 200)
jobs.add_job(False, False, 784, 50, 100, 0.01, 1, 200, 1, [20, 10], 10, 0.02, 200)
jobs.add_job(True, True, 784, 200, 30, 0.02, 2, 150, 1, [12,12,12], 12, 0.01, 150)
jobs.add_job(False, True, 784, 50, 20, 0.02, 1, 300, 1, [20, 10], 10, 0.05, 300)
jobs.add_job(False, False, 784, 80, 30, 0.01, 1, 100, 1, [8,6,8], 8, 0.05, 100)
jobs.add_job(True, True, 784, 25, 100, 0.01, 2, 300, 1, [10,20, 100], 100, 0.05, 300)
jobs.add_job(False, True, 784, 50, 10, 0.03, 1, 300, 1, [10,20, 10,20,10], 10, 0.05, 300)
jobs.add_job(True, False, 784, 50, 15, 0.02,3, 100, 1, [20, 10], 10, 0.01, 100)
jobs.add_job(True, False, 784, 50, 15, 0.02,3, 100, 1, [4,4,4,4,4,4], 4, 0.01, 100)
jobs.run_all_jobs()
